# This program converts distances in kilometers to miles. The result is displayed in an info dialog box.
import tkinter
...
class KiloConverterGUI:
    def __init__(self):
        ...
        # Create the widgets for the button widgets for the bottom frame
...
# Cteate an instance of the KiloConverterGUI class
