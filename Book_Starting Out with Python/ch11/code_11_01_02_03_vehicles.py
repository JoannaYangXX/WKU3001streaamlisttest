...
class Automobile:
    # The __init__method accepts arguments for the make, model, mileage, and price. It initializes the data attributes with these values
    ...
    # the following methods are matators for the class's data attributes      
