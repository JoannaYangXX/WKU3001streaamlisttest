# 11-8
# This program creates an instance of the SavingsAccount class and an instance of the CD account
import code_11_07_08_accounts

def main():
    # Get the account number, interest rate, and account balance for a savings account.
    ...
    savings = code_11_07_08_accounts.SavingsAccount(acct_num, int_rate, balance)
    ...
    # Create a CD object.
    cd = code_11_07_08_accounts.CD(acct_num, int_rate, balance, maturity)
