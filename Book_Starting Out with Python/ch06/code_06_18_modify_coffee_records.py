# code_06_18_modify_coffee_records.py
...
# Notice at the end of the algorithm you delete the original file then rename the temporary file. The Python standard library’s os module provides a function named remove, that de- letes a file on the disk. You simply pass the name of the file as an argument to the function. Here is an example of how you would delete a file named coffee.txt:
...
def main():
    ...
    # Read teh first record's description field
    ...
    while descr != '':
        ...
        # Write either this record to the temporary file, or the new record if this is the one that is to be modified.
        ...
        if descr == search:
            ...
            # Write the oritinal record to the temp file
            temp_file.write(descr + '\n')
