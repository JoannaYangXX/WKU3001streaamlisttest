# code_10_19_contact_manager
# This program manage contacts.

import code_10_18_contact
import pickle
...
# load contact open the contacts.dat file and load dictionary object from it, unpickle it, and assigns it to the contact_dct variable
def load_contacts():
    try:
        ...
        # Could not oopen the file, so create an empty dictionary
        contact_dct = {}
...
# The look_up function looks uip an item in the specified dictionary 
...
def add(mycontacts):
    ...
    entry = code_10_18_contact.Contact(name, phone, email)

    # If the name does not exist in the dictionary, add it as a key with the entiry object as the associated value.
...
def change(mycontacts):
    ...
    if name in mycontacts:
        ...
        # Get a contact object named entry.
        entry = code_10_18_contact.Contact(name, phone, email)
        # Update the entry.
        mycontacts[name] = entry
...
# The save_contacts function piclkes the specified object and saves it to the contacts file.
