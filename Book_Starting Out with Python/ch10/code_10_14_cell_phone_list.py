# code_10_14_cell_phone_list.py
# This program creates five CellPhone objects and stores them in a list

import code_10_12_cellphone as cellphone
...
# The display_list funtion accepts a list containing CellPhone objects as an argument and displays the data stored in each object
