...
class EmployeeDetails:
    ...
    def _setup_listbox(self):
        ...
        self.employee_listbox.bind('<<ListboxSelect>>', self._get_details)
    ...
    def _get_details(self, event):
        ...
        try:
            ...
            # Execute the SELECT query.
            cur.execute('''
                SELECT Employees.Name, Employees.Position, Departments.DepartmentName, Locations.City
                FROM Employees, Departments, Locations
                WHERE Employees.Name == ? AND Employees.DepartmentID == Departments.DepartmentID
                AND Employees.LocationID == Locations.LocationID
            ''', (selected_emp,))
            ...
            self._display_details(name=results[0], position=results[1],
    ...
    def _display_details(self, name, position, department, location):
        tkinter.messagebox.showinfo('Employee Details', 'Name: ' + name +
